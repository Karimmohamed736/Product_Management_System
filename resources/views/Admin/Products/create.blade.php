            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="title[ar]" class="form-control" value="{{ old('title.ar') }}" dir="rtl">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="description[ar]" class="form-control" rows="3" dir="rtl">{{ old('description.ar') }}</textarea>
                    </div>
                </div>
